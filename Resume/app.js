...
function addExperience(){
    ...
    if(experience_count<5)
    {
        ...
        <div class="mb-3">
            ...
            <input type="text" name="company${experience_count}" class="form-control">
        </div>
        <div class="mb-3 d-flex justify-content-between">
            <div>
                <label for="exampleInputEmail1" class="form-label">From</label>
                <input type="text" name="from${experience_count}" class="form-control">
            </div>
            <div>
                <label for="exampleInputEmail1" class="form-label">To</label>
                <input type="text" name="to${experience_count}" class="form-control">
            </div>
        </div>
        <div class="mb-3">
